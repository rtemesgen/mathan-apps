...
export const RecordTransactionPage: React.FC<RecordTransactionPageProps> = ({
  ...
  const form = useTruckTransactionForm({ owners, customers, trucks, currentTruckId, defaultOwnerId, defaultType, active: true, onSubmit, onComplete: onBack });
  const { truckId, setTruckId, type, ownerId, setOwnerId, customerId, setCustomerId, amount, setAmount, category, setCategory, description, setDescription, referenceNo, setReferenceNo, counterpartyType, setCounterpartyType, counterpartyName, setCounterpartyName, date, setDate, submitting, handleTypeChange, handleSubmit } = form;
