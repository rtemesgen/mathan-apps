...
export function AppUpdateNotice() {
  ...
  return (
    <div className="native-safe-bottom fixed bottom-3 left-3 right-3 z-[200] mx-auto flex max-w-md items-center gap-3 rounded-2xl border border-[#d8d3c5] bg-white p-3 shadow-2xl">
      ...
      <div className="min-w-0 flex-1"><p className="text-xs font-extrabold text-zinc-900">Update available</p><p className="mt-0.5 text-[11px] text-zinc-500">Mathan ERP {update.version} is ready to download.</p></div>
      <button onClick={openUpdate} className="rounded-xl bg-zinc-900 px-3 py-2 text-[11px] font-bold text-white">Update</button>
