...
export function SettingsPage() {
  ...
  type SettingsSection = 'company' | 'apps' | 'invites' | 'appdata' | 'people' | 'profile' | 'security' | 'audit' | 'approvals' | 'trash';
  ...
  const navItems = [
    ...
    ...(isOwner ? [{ id: 'company' as const, label: 'Company' }, { id: 'apps' as const, label: 'Apps' }, { id: 'invites' as const, label: 'Invitations' }, { id: 'appdata' as const, label: 'App data' }, { id: 'audit' as const, label: 'Activity' }, { id: 'approvals' as const, label: 'Approvals' }, { id: 'trash' as const, label: 'Trash' }] : [{ id: 'appdata' as const, label: 'App data' }, { id: 'approvals' as const, label: 'Approvals' }]),
  ];
