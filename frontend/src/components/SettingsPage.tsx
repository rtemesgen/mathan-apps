...
import { Check, ChevronDown, ChevronRight, Copy, Eye, EyeOff, LogIn, Mail, Power, Share2, ShieldCheck, UserMinus, UserPlus, X } from 'lucide-react';
...
export function SettingsPage() {
  ...
  const [activeSection, setActiveSection] = useState<'company' | 'apps' | 'invites' | 'people' | 'profile' | 'security'>(requestedSection === 'invites' || requestedSection === 'people' ? requestedSection : 'profile');
