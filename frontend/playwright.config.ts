...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: 'npm run dev -- --host 127.0.0.1 --port 4173', cwd: process.cwd(), env: { ...process.env, VITE_SUPABASE_URL: local.API_URL, VITE_SUPABASE_ANON_KEY: local.ANON_KEY, VITE_STANDALONE: 'false', VITE_DEMO_EMAIL: '', VITE_DEMO_PASSWORD: '' }, url: 'http://127.0.0.1:4173', reuseExistingServer: false, timeout: 60_000, stdout: 'pipe', stderr: 'pipe' },
  ],
