-- Reapply the idempotent snapshot RPC repair for projects whose migration
-- history recorded the original receipts migration but retained its ambiguous
-- function body. This only replaces the function definition; no records or
