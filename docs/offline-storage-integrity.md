...
- The 5 MB attachment policy has unit coverage. Native capacity measurements for 1/3/near-5 MB payloads and multiple attachments are still required before raising or removing that bound.
